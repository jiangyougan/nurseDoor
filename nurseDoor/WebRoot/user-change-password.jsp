	...
	<form action="/" method="post" class="form form-horizontal" id="form-change-password">
		...
		<div class="row cl">
			<div class="col-8 col-offset-4">
				<input class="btn btn-primary radius" onclick="submitFrom('<%=userId %>')" type="button" value="&nbsp;&nbsp;保存&nbsp;&nbsp;">
			</div>
		</div>
	</form>
</div>
...
layer.confirm('确认要修改吗？',function(index){
			$.ajax({
						url: "${pageContext.request.contextPath}/updateUserPwd.action",              //请求地址
				        type: "POST",                       //请求方式
				        data: { "userId": id,"pwd":pwd1},        //请求参数
				        dataType: "json",
