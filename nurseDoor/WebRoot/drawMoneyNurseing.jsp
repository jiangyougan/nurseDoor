...
<ul class="nav nav-tabs">
  <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/selectNurseDrawMoneyNow.action">申请中</a></li>
  <li role="presentation"><a href="${pageContext.request.contextPath}/selectNurseDrawMoneyNed.action">申请过</a></li>
</ul>	
          ...
          <tr>
            ...
            <td style="text-align: center;">
            	<div class="btn-group btn-group-lg" role="group" aria-label="Large button group">
				     <a class="but"  href="${pageContext.request.contextPath}/delDrawMoneyByNurseId.action?drawMoneyId=${s.drawMoneyId}&drawMoneySize=${s.drawMoneySize}&nurseId=${s.drawMoneyUsersId}"> <button onclick="return confirm('是否驳回?')" type="button" class="btn btn-danger" >驳回</button></a>
				      <a class="but" href="${pageContext.request.contextPath}/giveNurseMoney.action?drawMoneyId=${s.drawMoneyId}"><button onclick="return confirm('是否同意提现?')" type="button" class="btn btn-success">提现</button></a>
   	 			</div>
            </td>
          </tr>
         </c:forEach>
