...
<input type="hidden" value="${adminstate }" id="adminstate" />
	<form action="${pageContext.request.contextPath}/addAdmin.action" method="post" class="form form-horizontal" id="form-admin-add" name="addadmin">
	<input type="hidden" value="<%=adminuser%>" id="adminUserId" name="adminUserId" />
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="" placeholder="" id="username" name="username" datatype="*2-16" nullmsg="账号不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="password" placeholder="密码" autocomplete="off" value="" class="input-text" datatype="*6-20" nullmsg="密码不能为空" id="newpassword" name="newpassword">
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" placeholder="请输入昵称"  class="input-text"  datatype="*"   id="nick" name="nick">
			</div>
			<div class="col-4"> </div>
		</div>
		...
		<div class="row cl">
			<div class="col-9 col-offset-3">
				<button class="btn btn-primary " style="border-radius:5px" id="butsumit" onclick="butsumit1()">提交</button>
				<a class="layui-layer-ico layui-layer-max"><button onclick="returnOnTo();" class="btn btn-primary" style="border-radius:5px">返回</button></a>
			</div>
		</div>
	</form>
...
function returnOnTo(){
location.href = "${pageContext.request.contextPath}/AdminList.action";
}
...
if(adminstate == "0"){
	layer.msg('该账号已注册!',{icon: 5,time:5000});
}else if(adminstate == "1"){
	layer.msg('注册成功!',{icon: 6,time:5000});
}
}
checkstate();
