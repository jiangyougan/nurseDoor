...
<div style="display:none;">
    <img src="img/ic_launcher_user.png"  />
</div>
<!--=== Breadcrumbs ===-->
<div class="row-fluid breadcrumbs margin-bottom-20">
    <div class="container">
        <h1 class="pull-left">护士上门</h1>
...
<% } %>
    ...
    <!-- android -->
	    <div class="view row">
	                <div class="span12" style="text-align:center;">
	                         <a href="javascript:void(0);" ><img src="img/ic_launcher_user.png" class="appicon"  /></a>
	        		</div>
	    </div>
	    ...
	    <div id="" class="view row" style="margin-top:30px;">    
	             ...
	             <div class="span12 margin-bottom-20" style="text-align:center;">
	                       <div class="spinner">
	                        	<a href="http://imtt.dd.qq.com/16891/B932EF8CB33BFFC2C4B14970FB82BCCD.apk?fsname=com.chance.homecareclient_1.0.42_42.apk&csr=4d5s"  id="down_load"  class="btn-u btn-u-lg"><i class="fa fa-download"></i> 点击下载</a>
    ...
    <hr class="devider devider-dotted">
        ...
        <div class="span12" style="text-align:center;">
            或者用手机扫描下面的二维码安装            <br />
            <br />
            <img src="img/user.png" style="width:156px; height:156px;" />
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8  col-xs-12 col-md-6 col-sm-6 text-left">
                                    <a href="#">护士上门</a>                    ｜
                                <a href="<%=webPath %>nurseDoor/agreement/userExemptionAgreement.html" target="_blank">免责声明</a>
