...
<form action="${pageContext.request.contextPath}/OrderKeyWordList.action" method="post">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		...
		<a class="btn btn-primary radius" onclick="picture_add('添加图片','nursingreport-add.jsp')" href="javascript:;">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
                ...
                <td style="text-align: center;">
                    ...
                    <a title="编辑" href="javascript:;" onclick="picture_show('管理员编辑','selectreportbyid.action?reportId=${s.manageNursingTestall}','1','800','500')"
                       class="ml-5" style="text-decoration:none">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
                    
                    <a title="删除" href="javascript:;" onclick="project_del(this,'${s.manageNursingTestall}')"
                       class="ml-5" style="text-decoration:none">
                        <i class="Hui-iconfont">&#xe6e2;</i>
                    </a>
