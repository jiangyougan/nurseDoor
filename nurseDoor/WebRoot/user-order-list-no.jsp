...
<ul class="nav nav-pills" role="tablist">
  <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/selectUserorderInfoNo.action?userId=${userId }&orderState=0"">待预约</a></li>
  <li role="presentation"><a href="${pageContext.request.contextPath}/selectUserorderInfoNo.action?userId=${userId }&orderState=1"">已预约</a></li>
  <li role="presentation"><a href="${pageContext.request.contextPath}/selectUserorderInfoNo.action?userId=${userId }&orderState=2"">进行中</a></li>
  <li role="presentation"><a href="${pageContext.request.contextPath}/selectUserorderInfoNo.action?userId=${userId }&orderState=3"">已完成</a></li>
</ul>
			...
			<tbody>
				<c:forEach items="${list}" var="s">
					<tr class="text-c">
						...
						<c:if test="${empty s.nursePhone}">
							<td class="text-c">待接取</td>
						</c:if>
						<c:if test="${!empty s.nursePhone}">
							<td class="text-c">${s.nursePhone} </td>
						</c:if>
