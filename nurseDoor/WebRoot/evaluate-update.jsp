...
<%
	...
	if(evaluateContent == null || "null".equals(evaluateContent)){
	evaluateContent = "";
	}
	 %>
<html>
...
<body>
<div class="pd-20">
  <form action="${pageContext.request.contextPath}/updateEevaluateById.action" method="post" class="form form-horizontal" name="form1" id="form1" enctype="multipart/form-data" >
  <input type="hidden" value="<%=evaluateId %>" name="evaluateId">
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<%=evaluateContent%>${evaluateContent}" placeholder="为空则不限制条件" id="content" name="content" minlength='5' >
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
