...
<div class="pd-20">
	...
	<ul class="nav nav-tabs" role="tablist">
  		<li role="presentation" class="active"><a href="${pageContext.request.contextPath}/selectGoodEvaluateInfoOfKeyWord.action">好评</a></li>
  		<li role="presentation" ><a href="${pageContext.request.contextPath}/selectMiddleEvaluateInfoOfKeyWord.action">中评</a></li>
  		<li role="presentation"><a href="${pageContext.request.contextPath}/selectBadEvaluateInfoOfKeyWord.action">差评</a></li>
	</ul>
	<div class="cl pd-5 bg-1 bk-gray mt-20">
	<form action="${pageContext.request.contextPath}/selectGoodEvaluateInfoOfKeyWordGood.action" method="post">
			<div class="text-c">日期范围：
