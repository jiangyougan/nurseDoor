...
<div class="pd-20">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<a class="btn btn-primary radius"  href="post-two-add.jsp?postOneLevelId=${postOneLevelId }">
		<i class="Hui-iconfont">&#xe600;</i> 
		添加二级
		</a>
		<a class="btn btn-primary radius" onclick="go_back('','${pageContext.request.contextPath}/selectOnePostInfo.action')" href="javascript:;">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			<thead>
				<tr class="text-c">
            		...
            		<th style="text-align: center;">二级名称</th>
			...
			<tbody>
				...
				<tr style="text-align: center;">
					...
					<td style="text-align: center;">${s.postTwoLevelNote }</td>
					<td style="text-align: center;">${s.postTwoLevelSpeak }</td>
					<td style="text-align: center;">${s.postTwoLevelCreateter }</td>
                	<td style="text-align: center;">
                    	<fmt:formatDate value="${s.postTwoLevelCreatetime }" type="both"/>
               		 </td>
                <td style="text-align: center;">
                   	...
                   	<a title="查看下一级" href="javascript:;" onclick="go_back('','${pageContext.request.contextPath}/postTwoLevelInfo.action?postOneLevelId=${s.postTwoLevelId}')" 
                       class="ml-5" style="text-decoration:none">
                        <img class="Hui-iconfont" alt="" style="width: 20px;height: 20px" src="images/icon_plus-box.png">
                    </a>	 
                    <a title="删除" href="javascript:;" onclick="project_del(this,'${s.postTwoLevelId}')"
                       class="ml-5" style="text-decoration:none">
                        <i class="Hui-iconfont">&#xe6e2;</i>
                    </a>
                   <%--  <c:if test="${(z.index) != 0 }">
