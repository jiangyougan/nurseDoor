...
<ul class="nav nav-pills" role="tablist">
  <li role="presentation" ><a href="${pageContext.request.contextPath}/selectUserorderInfoNo.action?userId=${userId }&orderState=0"">待预约</a></li>
  <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/selectUserorderInfoNo.action?userId=${userId }&orderState=1"">已预约</a></li>
