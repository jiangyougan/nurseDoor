...
<div class="pd-20">
	...
	<div class="mt-20">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<c:forEach items="${majors }" var="s">
				<tr style="text-align: center;">
				
			 		<td style="text-align: center;"><input type="checkbox" value="1" name=""></td>
                	<td style="text-align: center;">${s.majorName }</td>
					<td style="text-align: center;">${s.majorNote }</td>
					
					
                	<td style="text-align: center;">
                    	<fmt:formatDate value="${s.majorCteatetime }" type="both"/>
               		 </td>
