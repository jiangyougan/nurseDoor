...
<table border="1" width="47%" height="250" style="border-width: 0px">
	...
	<tr>
		...
		<form class="contact_form" action="updatePostThreeInfo.action" method="post" name="contact_form" enctype="multipart/form-data">
		<input type="hidden" value="${threeLevelDetails.postThreeLevelDetailsId }" id="postThreeLevelDetailsId" name="postThreeLevelDetailsId">
    <ul>
        <li>
             <h2>发帖</h2>
        ...
        <li>
            ...
            <input type="text" name="title" value="${threeLevelDetails.postThreeLevelDetailsTitle }"  placeholder="Chinaz" required />
        </li>
        <li>
         <label for="name">帖子描述:</label>
        <textarea name="message" cols="40" rows="6"   required >${threeLevelDetails.postThreeLevelDetailsSpeak }</textarea>
        </li>
        <li>
            <label for="email">选择帖子关联:</label>
            <select name="postTwoName" id="postTwoName">
        ...
        <li>
           ...
           <div style="margin-top: 5%">
					...
					${threeLevelDetails.postThreeLevelDetailsContent }
				</script>
           </div>
...
<input type="hidden" value="${threeLevelDetails.postThreeLevelDetailsAdd }" id="postThreeLevelDetailsAdd">
<input type="hidden" value="${threeLevelDetails.postTwoLevelId }" id="postTwoLevelId">
</div>
...
function test1(){
 var value_s=$('#postTwoLevelId').val();
 var check = $('#postThreeLevelDetailsAdd').val();
 //alert(value_s);
 var osel1=document.getElementById("postTwoName"); 
