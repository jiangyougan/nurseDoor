...
<ul class="nav nav-tabs">
 <li role="presentation" ><a href="${pageContext.request.contextPath}/selectUserDrawMoneyNow.action">申请中</a></li>
  <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/selectUserDrawMoneyNed.action">申请过</a></li>
</ul>	
          ...
          <tr>
           ...
           <td style="text-align: center;">
	           <c:if test="${s.drawMoneyState == 2 }">
	             <button type="button" class="btn btn-danger" >提现驳回</button>
	           </c:if>
