...
<ul class="nav nav-pills" role="tablist">
  <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/capitalplatinfo.action">平台资金明细</a></li>
			...
			<tbody>
				<c:forEach items="${list}" var="s">
					<tr class="text-c">
						...
						<td >${s.capitalPlatformId}</td>
						
						<td class="text-c">${s.capitalPlatformMoney}</td>
						
						
						<td class="text-c">${s.capitalPlatformNote}</td>
						
						<td >
							<fmt:formatDate value="${s.capitalPlatformCreatetime}" type="both"/>
						</td>
						...
						<a style="text-decoration:none" class="ml-5" onClick="picture_edit('订单详情','OrderInfoByOrderId.action?orderSendId=${s.capitalPlatformOrderSendId}','100001')" href="javascript:;" title="编辑">
