		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			<thead>
				<tr class="text-c">
            		...
            		<th style="text-align: center;">备注名</th>
			...
			<tbody>
				<c:forEach items="${noteList}" var="s"  varStatus="z">
				<tr style="text-align: center;">
			 		<td style="text-align: center;"><input type="checkbox" value="1" name=""></td>
                	<td style="text-align: center;">${z.index+1 }</td>
				    <td style="text-align: center;">${s.noteName }</td> 
				

                	<td style="text-align: center;">${s.noteCrteadmin }</td>

                	<td style="text-align: center;">
                    	<fmt:formatDate value="${s.noteCrtetime }" type="both"/>
               		 </td>
                ...
                <td style="text-align: center;">
                    ...
                    <a title="编辑" href="javascript:;" onclick="picture_show('管理员编辑','webNoteModifyById.action?noteId=${s.noteId}','1','800','500')"
                       class="ml-5" style="text-decoration:none">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
                    <!-- <a title="查看" href="javascript:;" onclick="admin_seach('管理员详细','selectcontentbyid.action?','800','800')"
                       class="ml-5" style="text-decoration:none">
                        <img class="Hui-iconfont" alt="" style="width: 13px;height: 13px" src="images/search-icon.png">
                    </a> -->
                   <%--  <a title="删除" href="javascript:;" onclick="project_del(this,'${s.noteId}')"
                       class="ml-5" style="text-decoration:none">
                        <i class="Hui-iconfont">&#xe6e2;</i>
                    </a> --%>
                </td>
