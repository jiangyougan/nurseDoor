...
<form method="post" class="form form-horizontal" id="form-article-add"onsubmit="return validate(document.getElementById('contentName'));">
			<div class="row cl">
				<label class="form-label col-2"><span class="c-red">*</span>交通费：</label>
				<div class="formControls col-4">
					<input type="text" style="width: 50%" class="input-text"  value="${costtraffic }" placeholder="" id="costTraffic" name="costTraffic"/>￥
				</div>
			</div>
...
<script type="text/javascript">
     ...
     var costTraffic = $("#costTraffic").val();
     if(costTraffic == null){
     alert("为空默认为0元");
     return;
     }
     		$.ajax({
						url: "${pageContext.request.contextPath}/updatecostTraffic.action",              //请求地址
				        type: "POST",                       //请求方式
				        data: { costTraffic: costTraffic},        //请求参数
				        dataType: "json",
